			    	...
			    	<div className="container">
				        <ul className="nav navbar-nav navbar-left">
				            <li><a href="/" className="navbar-brand">
				              	<i className="fa fa-home" aria-hidden="true"></i> Mock Pinterest App
				            </a></li>
				        </ul>
						{this.props.user ? (
							<ul className="nav navbar-nav navbar-right">
								<li>
									<a><i className="fa fa-user-circle-o" aria-hidden="true"></i> Signed in as {this.props.user.username}</a>
								</li>
								<li> 
			    ...
			    <nav className="navbar navbar-default " role="navigation">
			    	<div className="container">
						...
						{this.props.user ? (
							<ul className="nav navbar-nav navbar-right">
								<li>
									<Link to="/profile"><i className="fa fa-user-circle-o" aria-hidden="true"></i> Profile</Link>
								</li>
								<li> 
									<a href="/auth/logout"><i className="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
								</li>
