			    ...
			    <nav className="navbar navbar-default" role="navigation">
			    	<div className="container">
				        <ul className="nav navbar-nav navbar-left">
				            <li>
				            	<Link to="/" className="navbar-brand"><i className="fa fa-home" aria-hidden="true"></i> Pintrest</Link>
				            </li>
				        </ul>
						{this.props.user ? (
							<ul className="nav navbar-nav navbar-right">
								<li>
									<Link to={"/user/"+this.props.user.username}><i className="fa fa-th" aria-hidden="true"></i> My Boards</Link>
								</li>
								<li> 
